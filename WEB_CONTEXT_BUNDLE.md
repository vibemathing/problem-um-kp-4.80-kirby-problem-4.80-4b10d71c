...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.80-kirby-problem-4.80-4b10d71c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.80"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.80-kirby-problem-4.80-4b10d71c-v1",
      "problem_contract_sha256": "e6a11c4fb8545eee31c09b96a9e9d0b64546effefe0c7393851596ce2a007078",
      "problem_id": "problem:um-kp-4.80-kirby-problem-4.80-4b10d71c",
      "route_id": "route:um-kp-4.80-kirby-problem-4.80-4b10d71c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.80-kirby-problem-4.80-4b10d71c-source-fidelity-01",
      "graph_id": "graph:um-kp-4.80-kirby-problem-4.80-4b10d71c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.80-kirby-problem-4.80-4b10d71c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.80-kirby-problem-4.80-4b10d71c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there $n >$ 2 and a smooth closed simply connected 4manifold X for which there is an element of ordernin the $subgroupker(\\pi_{0}\\operatorname{Diff}(X) \\to \\pi_{0}\\operatorname{Homeo}(X))$? More generally, is there a subgroup of order nin $\\ker(\\pi_{0}\\operatorname{Diff}(X) \\to \\pi_{0}\\operatorname{Homeo}(X))$?"
          },
          "statement_sha256": "536b7a63a8f5513862e29a7c62318b305da5c3a81cd37ada9da5730214eace26"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.80-kirby-problem-4.80-4b10d71c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.80-kirby-problem-4.80-4b10d71c-root",
      "route_id": "route:um-kp-4.80-kirby-problem-4.80-4b10d71c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.80-2090090107e6",
        "url": "https://www.unsolvedmath.com/problems/KP-4.80"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
